...
```
[terraform/00-sa/main.tf](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/terraform/00-sa/main.tf)
```
terraform {
...
[terraform/01-infra/variables.tf](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/terraform/01-infra/variables.tf)
...
```
[terraform/01-infra/main.tf](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/terraform/01-infra/main.tf)
```
terraform {
  required_version = ">= 1.0"
  required_providers {
...
```
[terraform/01-infra/network.tf](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/terraform/01-infra/network.tf)
```
# VPC сеть
...
```
[terraform/01-infra/k8s.tf](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/terraform/01-infra/k8s.tf)
```
...
[diplom-test-app/dockerfile](https://github.com/ViktorLebedev93/diplom-test-app/blob/main/dockerfile)
```
FROM nginx:alpine
...
```
[diplom-test-app/nginx.conf](https://github.com/ViktorLebedev93/diplom-test-app/blob/main/nginx.conf)
```
events {
...
```
[diplom-test-app/index.html](https://github.com/ViktorLebedev93/diplom-test-app/blob/main/index.html)
```
<!DOCTYPE html>
<html>
<head>
...
Создаем манифест деплоя для K8S
[k8s/deployment.yaml](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/k8s/deployment.yaml)
...
[k8s/prom-values.yaml](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/k8s/prom-values.yaml)
```
server:
  tolerations:
    - key: preemptible
...
Манифест для деплоя Графаны k8s
[k8s/grafana.yaml](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud/blob/main/k8s/grafana.yaml)
```
apiVersion: apps/v1
kind: Deployment
metadata:
...
Создаем пайплайн в репозитории приложения .github/workflows/ci-cd.yml

[.github/workflows/ci-cd.yml](https://github.com/ViktorLebedev93/diplom-test-app/blob/main/.github/workflows/ci-cd.yml)
...
| Репозиторий | Ссылка |
|-------------|--------|
| **Terraform инфраструктура** | [devops-diplom-yandexcloud](https://github.com/ViktorLebedev93/devops-diplom-yandexcloud) |
| **Тестовое приложение + CI/CD** | [diplom-test-app](https://github.com/ViktorLebedev93/diplom-test-app) |
